...
export const LINKEDIN_LINK = "https://www.linkedin.com/in/vaibhav1512/";
export const GiTHUB_LINK = "https://github.com/vaibhav-98";
export const TWITTER_LINK = "https://x.com/Vaibhav02119256";
export const EMAIL_LINK = "vaibhavtripathi1512@gmail.com";


// Github - username and repository name
export const GITHUB_USERNAME = "vaibhav-98";
export const GITHUB_REPOSITORY_NAME = "Swiggy_Clone_App";
